...
export const generateSimpleMarkets = (): MarketListQuery => {
...
export const generateMarketsCandles = (): MarketsCandlesQuery => {
    ...
    },
    {
      ...
      candlesConnection: {
        ...
        edges: [
          ...
          __typename: 'CandleEdge',
          node,
        })) as unknown as MarketsCandlesNodeFieldsFragment[],
      },
    },
    {
      id: 'de74a5572045b300e8ec50d136896912ec76e7d7ec135bc305dfd4854d9363a4',
  ...
  return {
    marketsConnection: {
      __typename: 'MarketConnection',
      edges: markets.map((node: MarketsCandlesNodeFieldsFragment) => ({
        __typename: 'MarketEdge',
        node,
      })),
    },
...
export const generateMarkets = (
  override: Partial<MarketListQuery>
): MarketListQuery => {
