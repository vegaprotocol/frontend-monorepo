...
import type { DealTicketFieldsFragment } from '@vegaprotocol/deal-ticket';
...
interface DealTicketBalanceProps {
  settlementAsset: DealTicketFieldsFragment['tradableInstrument']['instrument']['product']['settlementAsset'];
