...
context('Network parameters page - verify elements on page', function () {
  before('visit token home page', function () {
    cy.visit('/');
  });

  describe('Network parameter page', function () {
  ...
  function verifyNetworkParametersPageDisplayed() {
    cy.get(commonLocators.networkParametersHeader).should('have.text', 'Network Parameters');
