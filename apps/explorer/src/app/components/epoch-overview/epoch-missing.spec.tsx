...
import EpochMissingOverview, { calculateEpochData, getSecondsFromInterval } from "./epoch-missing"
...
describe('calculateEpochData', () => {
    it('Handles bad data', () => {
        ...
        const res = calculateEpochData(currentEpochId, missingEpochId, epochStart, epochLength)
