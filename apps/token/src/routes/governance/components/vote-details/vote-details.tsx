  ...
  return (
    <section>
      ...
      <table className="w-full">
        ...
        <tbody>
          <tr>
            <td className="text-left" data-testid="vote-progress-indicator-percentage-for">
            ...
            <td className="text-right" data-testid="vote-progress-indicator-percentage-against">
              {noPercentage.toFixed(defaultDecimals)}%
            </td>
          </tr>
          <tr>
          <td data-testid="vote-progress-indicator-tokens-for"> {formatNumber(yesTokens, defaultDecimals)} </td>
            <td></td>
            <td data-testid="vote-progress-indicator-tokens-against" className="text-right">
