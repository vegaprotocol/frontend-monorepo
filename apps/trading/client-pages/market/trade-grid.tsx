  ...
  ({ marketId, pinnedAsset }: BottomPanelProps) => {
    ...
    return 'xxxl' === screenSize ? (
      <ResizableGrid proportionalLayout minSize={200}>
        ...
        >
          <TradeGridChild>
            <Tabs persistId="console-trade-grid-orders">
        ...
        >
          <TradeGridChild>
            <Tabs persistId="console-trade-grid-positions">
      ...
      <ResizableGrid vertical>
        <ResizableGridPanel minSize={75} priority={LayoutPriority.High}>
          <ResizableGrid proportionalLayout={false} minSize={200}>
            ...
            >
              <TradeGridChild>
                <Tabs persistId="console-trade-grid-chart">
            ...
            >
              <TradeGridChild>
                <Tabs persistId="console-trade-grid-ticket">
            ...
            >
              <TradeGridChild>
                <Tabs persistId="console-trade-grid-orderbook">
