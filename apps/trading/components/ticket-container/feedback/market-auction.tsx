...
export const MarketAuction = ({
  ...
  if (marketTradingMode === MarketTradingMode.TRADING_MODE_MONITORING_AUCTION) {
    msg = (
      <p data-testid="feedback-market-monitoring-auction">
        {t(
  ...
  if (marketTradingMode === MarketTradingMode.TRADING_MODE_OPENING_AUCTION) {
    msg = (
      <p data-testid="feedback-market-opening-auction">
        {t(
  ...
  return (
    <div className="flex flex-col gap-1 text-xs text-vega-blue-600">
      {msg}
