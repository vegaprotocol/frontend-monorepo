...
export const createOrderSubmission = (
...
export const createStopOrdersSubmission = (
...
export const createTpSl = (
  ...
  if (formValues.takeProfit && formValues.stopLoss) {
    const ocoStopOrderSubmission = createStopOrdersSubmission(
      {
        ...formValues,
    ...
    const takeProfitStopOrderSubmission = createStopOrdersSubmission(
      {
        ...formValues,
    ...
    const stopLossStopOrderSubmission = createStopOrdersSubmission(
      {
        ...formValues,
        triggerPrice: formValues.stopLoss,
        price: formValues.stopLoss,
