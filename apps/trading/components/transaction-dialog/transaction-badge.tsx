    ...
    <div className={classNames(BADGE_SIZING, BADGE_BACKGROUND)}>
      <div className={INNER_ICON_SIZING}>
        <VegaIcon
          ...
          size={24}
          className={classNames('animate-spin', 'stroke-gs-200')}
        />
      </div>
    </div>
  );
  ...
  return (
    <div className={classNames(BADGE_SIZING, BADGE_BACKGROUND)}>
      <VegaIcon
        ...
        size={24}
        className={classNames(INNER_ICON_SIZING, 'fill-gs-50')}
      />
    </div>
  );
};
  ...
  return (
    <div className={classNames(BADGE_SIZING, BADGE_BACKGROUND)}>
      <VegaIcon
        ...
        size={24}
        className={classNames(INNER_ICON_SIZING, 'stroke-gs-200')}
      />
    </div>
  );
};
...
export const ConfirmedBadge = () => {
  return (
    <div className={classNames(BADGE_SIZING, 'bg-gs-50 ')}>
      <VegaIcon
        name={VegaIconNames.SLIM_TICK}
        size={24}
        className={classNames(INNER_ICON_SIZING, 'stroke-gs-900')}
      />
    </div>
  );
};
