    ...
    <div className="md:hidden overflow-hidden flex">
      <button
        className={classNames(
          'my-2 transition-all flex flex-col justify-around gap-3 p-2 relative z-20 h-[34px]',
          { 'z-50': drawerOpen }
        )}
        onClick={openDrawer}
      ...
      >
        ...
        <>
          <div
            className={classNames(
              'w-[26px] h-[2px] bg-black dark:bg-white transition-all',
              {
                hidden: !drawerOpen,
