  ...
  if (data && typeof data == 'object' && !Array.isArray(data)) {
    ...
    if (data.networkId === undefined) {
      const err1 = {
        ...
        schemaPath: '#/required',
        keyword: 'required',
        params: { missingProperty: 'networkId' },
        message: "must have required property '" + 'networkId' + "'",
      };
      if (vErrors === null) {
        vErrors = [err1];
      } else {
    ...
    if (data.networkId !== undefined) {
      if (typeof data.networkId !== 'string') {
        const err4 = {
          instancePath: instancePath + '/networkId',
          schemaPath: '#/properties/networkId/type',
          keyword: 'type',
          params: { type: 'string' },
          message: 'must be string',
        };
