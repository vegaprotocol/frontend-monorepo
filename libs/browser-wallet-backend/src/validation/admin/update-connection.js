  ...
  if (data && typeof data == 'object' && !Array.isArray(data)) {
    ...
    if (data.autoConsent === undefined) {
      const err1 = {
        ...
        schemaPath: '#/required',
        keyword: 'required',
        params: { missingProperty: 'autoConsent' },
        message: "must have required property '" + 'autoConsent' + "'",
      };
      if (vErrors === null) {
        vErrors = [err1];
      } else {
    ...
    for (const key0 in data) {
      if (!(key0 === 'origin' || key0 === 'autoConsent')) {
        const err2 = {
          instancePath,
    ...
    if (data.autoConsent !== undefined) {
      if (typeof data.autoConsent !== 'boolean') {
        const err4 = {
          instancePath: instancePath + '/autoConsent',
          schemaPath: '#/properties/autoConsent/type',
          keyword: 'type',
          params: { type: 'boolean' },
