declare global {
    ...
    namespace Cypress {
      ...
      interface Chainable<Subject> {
        vega_wallet_receive_fauceted_asset(assetName: string, amount: string, vegaWalletPublicKey: string): void;
      }
    }
  }
...
export function addVegaWalletReceiveFaucetedAsset() {
  ...
  Cypress.Commands.add('vega_wallet_receive_fauceted_asset', function (assetName, amount, vegaWalletPublicKey) {
