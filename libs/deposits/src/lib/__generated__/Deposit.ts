...
export type DepositFieldsFragment = { __typename?: 'Deposit', id: string, amount: string, createdTimestamp: string, creditedTimestamp?: string | null, txHash?: string | null, depositStatus: Types.DepositStatus, asset: { __typename?: 'Asset', id: string, symbol: string, decimals: number } };
...
export type DepositsQuery = { __typename?: 'Query', party?: { __typename?: 'Party', id: string, depositsConnection?: { __typename?: 'DepositsConnection', edges?: Array<{ __typename?: 'DepositEdge', node: { __typename?: 'Deposit', id: string, amount: string, createdTimestamp: string, creditedTimestamp?: string | null, txHash?: string | null, depositStatus: Types.DepositStatus, asset: { __typename?: 'Asset', id: string, symbol: string, decimals: number } } } | null> | null } | null } | null };
