...
export const Cattle = (props: SVGAttributes<SVGElement>) => {
  return (
    <EmblemSvg {...props} viewBox="0 0 150 150">
      <style>{`.cattle-1{fill:#fceebb;}.cattle-1,.cattle-2,.cattle-3,.cattle-4,.cls-5{stroke:#000000;stroke-miterlimit:10;}.cattle-1,.cls-5{stroke-width:2px;}.cattle-2{fill:#7d7d81;stroke-width:3px;}.cattle-3{fill:#dbdbdb;}.cattle-3,.cattle-4{stroke-width:4px;}.cattle-4{fill:#e2bda8;}.cls-5{fill:#ffffff;}`}</style>
      <path
        className="cattle-1"
      ...
      />
      <ellipse className="cattle-4" cx="75" cy="115.81" rx="30.3" ry="25.85" />
      <circle cx="56.3" cy="59.35" r="5.01" />
      <circle cx="93.7" cy="59.35" r="5.01" />
      <circle className="cls-5" cx="62.82" cy="117.37" r="5.52" />
      <circle className="cls-5" cx="87.18" cy="117.37" r="5.52" />
    </EmblemSvg>
  );
};
