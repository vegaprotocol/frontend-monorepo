  ...
  market(id: $marketId) {
    ...
    data {
      ...
      liquidityProviderFeeShare {
        ...LiquidityProvisionFeeShareFields
      }
    }
  }
}
    ${LiquidityProvisionFeeShareFieldsFragmentDoc}`;
