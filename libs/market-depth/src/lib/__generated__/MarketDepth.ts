...
export type PriceLevelFieldsFragment = { __typename?: 'PriceLevel', price: string, volume: string, ammVolume: string, ammVolumeEstimated: string, numberOfOrders: string };
...
export type MarketDepthQuery = { __typename?: 'Query', market?: { __typename?: 'Market', id: string, depth: { __typename?: 'MarketDepth', sequenceNumber: string, sell?: Array<{ __typename?: 'PriceLevel', price: string, volume: string, ammVolume: string, ammVolumeEstimated: string, numberOfOrders: string }> | null, buy?: Array<{ __typename?: 'PriceLevel', price: string, volume: string, ammVolume: string, ammVolumeEstimated: string, numberOfOrders: string }> | null } } | null };
...
export type MarketDepthUpdateSubscription = { __typename?: 'Subscription', marketsDepthUpdate: Array<{ __typename?: 'ObservableMarketDepthUpdate', marketId: string, sequenceNumber: string, previousSequenceNumber: string, sell?: Array<{ __typename?: 'PriceLevel', price: string, volume: string, ammVolume: string, ammVolumeEstimated: string, numberOfOrders: string }> | null, buy?: Array<{ __typename?: 'PriceLevel', price: string, volume: string, ammVolume: string, ammVolumeEstimated: string, numberOfOrders: string }> | null }> };
