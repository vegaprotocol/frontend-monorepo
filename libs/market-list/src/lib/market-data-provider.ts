...
import { MarketsDataDocument, MarketDataEventDocument } from './__generated__/MarketData';
import type {
  MarketsDataQuery,
...
const update = (data: MarketDataFieldsFragment, delta: MarketDataFieldsFragment) => {
