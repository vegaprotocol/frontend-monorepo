...
export const MarketInfoMainnetDocument = gql`
...
/**
 * __useMarketInfoMainnetQuery__
 *
 * To run a query within a React component, call `useMarketInfoMainnetQuery` and pass it any options that fit your needs.
 * When your component renders, `useMarketInfoMainnetQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useMarketInfoMainnetQuery({
 *   variables: {
 *      marketId: // value for 'marketId'
 *   },
 * });
 */
export function useMarketInfoMainnetQuery(baseOptions: Apollo.QueryHookOptions<MarketInfoMainnetQuery, MarketInfoMainnetQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<MarketInfoMainnetQuery, MarketInfoMainnetQueryVariables>(MarketInfoMainnetDocument, options);
      }
export function useMarketInfoMainnetLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<MarketInfoMainnetQuery, MarketInfoMainnetQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<MarketInfoMainnetQuery, MarketInfoMainnetQueryVariables>(MarketInfoMainnetDocument, options);
        }
export type MarketInfoMainnetQueryHookResult = ReturnType<typeof useMarketInfoMainnetQuery>;
export type MarketInfoMainnetLazyQueryHookResult = ReturnType<typeof useMarketInfoMainnetLazyQuery>;
export type MarketInfoMainnetQueryResult = Apollo.QueryResult<MarketInfoMainnetQuery, MarketInfoMainnetQueryVariables>;
