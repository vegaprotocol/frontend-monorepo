...
describe('useOracleMarkets', () => {
  it('should return oracle markets', () => {
    const provider: Provider = {
      ...
      proofs: [
        ...
        },
        {
          ...
          available: true,
          type: 'eth_address',
          eth_address: '0x0b38D0e7391CF427d309991A110a84daF37114eF',
          message: 'SOMEHEX',
        },
      ],
      github_link:
        'https://github.com/vegaprotocol/well-known/blob/main/oracle-providers/public_key-69464e35bcb8e8a2900ca0f87acaf252d50cf2ab2fc73694845a16b7c8a0dc6f.toml',
    };

    const markets = useOracleMarkets(provider);
    const expected = [
      {
        __typename: 'Market',
  ...
  marketsConnection: {
    ...
    edges: [
      ...
      },
      {
        ...
        node: {
          __typename: 'Market',
          id: '3fbfcd9e2f84a402f5a9808a193b39194e5f909d288fe4b696e4dee9e9c909d7',
          state: 'STATE_PENDING',
          tradingMode: 'TRADING_MODE_OPENING_AUCTION',
          tradableInstrument: {
            __typename: 'TradableInstrument',
            instrument: {
              ...
              product: {
                ...
                dataSourceSpecForSettlementData: {
                  __typename: 'DataSourceSpec',
                  id: 'bd42bc9e231f6bbbe9a48fbfa078b84951b52b00e8c1419fab180d97f5d21e2c',
                  data: {
                    __typename: 'DataSourceDefinition',
                    sourceType: {
                      __typename: 'DataSourceDefinitionExternal',
                ...
                dataSourceSpecForTradingTermination: {
                  __typename: 'DataSourceSpec',
                  id: '4f4c7ea2b67b879825679b6bdfc2c9b451b988ad45d2d570ba27ccccb6c546ca',
                  data: {
                    __typename: 'DataSourceDefinition',
                    sourceType: {
                      __typename: 'DataSourceDefinitionExternal',
                ...
                dataSourceSpecBinding: {
                  ...
                  tradingTerminationProperty: 'trading.terminated.LINK-II',
                },
              },
            },
          },
