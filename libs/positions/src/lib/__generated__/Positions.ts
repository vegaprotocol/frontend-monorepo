...
export type PositionsEventSubscriptionVariables = Types.Exact<{
  partyId: Types.Scalars['ID'];
}>;


export type PositionsEventSubscription = { __typename?: 'Subscription', positions: { __typename?: 'Position', realisedPNL: string, openVolume: string, unrealisedPNL: string, averageEntryPrice: string, updatedAt?: string | null, marginsConnection: { __typename?: 'MarginConnection', edges?: Array<{ __typename?: 'MarginEdge', node: { __typename?: 'MarginLevels', maintenanceLevel: string, searchLevel: string, initialLevel: string, collateralReleaseLevel: string, market: { __typename?: 'Market', id: string }, asset: { __typename?: 'Asset', symbol: string } } }> | null }, market: { __typename?: 'Market', id: string, name: string, decimalPlaces: number, positionDecimalPlaces: number, tradingMode: Types.MarketTradingMode, tradableInstrument: { __typename?: 'TradableInstrument', instrument: { __typename?: 'Instrument', name: string } }, data?: { __typename?: 'MarketData', markPrice: string, market: { __typename?: 'Market', id: string } } | null } } };
...
export const PositionsEventDocument = gql`
    subscription PositionsEvent($partyId: ID!) {
...
/**
 * __usePositionsEventSubscription__
 *
 * To run a query within a React component, call `usePositionsEventSubscription` and pass it any options that fit your needs.
 * When your component renders, `usePositionsEventSubscription` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the subscription, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = usePositionsEventSubscription({
 *   variables: {
 *      partyId: // value for 'partyId'
 *   },
 * });
 */
export function usePositionsEventSubscription(baseOptions: Apollo.SubscriptionHookOptions<PositionsEventSubscription, PositionsEventSubscriptionVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useSubscription<PositionsEventSubscription, PositionsEventSubscriptionVariables>(PositionsEventDocument, options);
      }
export type PositionsEventSubscriptionHookResult = ReturnType<typeof usePositionsEventSubscription>;
export type PositionsEventSubscriptionResult = Apollo.SubscriptionResult<PositionsEventSubscription>;