...
export type BatchproposalListFieldsFragment = { __typename: 'BatchProposal', datetime: any, reference: string, state: Types.ProposalState, rejectionReason?: Types.ProposalRejectionReason | null, errorDetails?: string | null, requiredMajority: string, requiredParticipation: string, requiredLpMajority?: string | null, requiredLpParticipation?: string | null, rationale: { __typename?: 'ProposalRationale', title: string, description: string }, batchTerms?: { __typename?: 'BatchProposalTerms', closingDatetime: any } | null, party: { __typename: 'Party', id: string }, votes: { __typename: 'ProposalVotes', yes: { __typename: 'ProposalVoteSide', totalTokens: string, totalNumber: string, totalWeight: string }, no: { __typename: 'ProposalVoteSide', totalTokens: string, totalNumber: string, totalWeight: string } } };
