...
export const BID_COLOR = tailwind.theme.colors.vega['green-30']; // vega-green with 30% opacity
export const ASK_COLOR = tailwind.theme.colors.vega['pink-60']; //vega-pink with 60% opacity
