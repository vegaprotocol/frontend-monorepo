...
export enum TransferTypeMapping {
  ...
  TRANSFER_TYPE_LOSS = 'Amount deducted after final settlement loss',
  TRANSFER_TYPE_WIN = 'Amount added after final settlement gain',
  TRANSFER_TYPE_CLOSE = 'Close',
  TRANSFER_TYPE_MTM_LOSS = 'Funds transferred out from mark to market loss',
  TRANSFER_TYPE_MTM_WIN = 'Funds transferred in from mark to market gain',
  TRANSFER_TYPE_MARGIN_LOW = 'Funds used to top up margin',
  TRANSFER_TYPE_MARGIN_HIGH = 'Excess margin amount returned',
  TRANSFER_TYPE_MARGIN_CONFISCATED = 'Margin confiscated to fulfil closeout',
  ...
  TRANSFER_TYPE_INFRASTRUCTURE_FEE_DISTRIBUTE = 'Infrastructure fee received',
  TRANSFER_TYPE_LIQUIDITY_FEE_PAY = 'Liquidity fee paid',
  TRANSFER_TYPE_LIQUIDITY_FEE_DISTRIBUTE = 'Liquidity fee received',
  TRANSFER_TYPE_BOND_LOW = 'Bond account funded to meet required bond amount',
  TRANSFER_TYPE_BOND_HIGH = 'Bond returned after liquidity commitment was reduced',
  TRANSFER_TYPE_WITHDRAW = 'Funds withdrawn',
  TRANSFER_TYPE_DEPOSIT = 'Funds deposited',
  TRANSFER_TYPE_BOND_SLASHING = 'Bond account slashed when liquidity commitment not met',
  TRANSFER_TYPE_STAKE_REWARD = 'Staking reward received',
  TRANSFER_TYPE_TRANSFER_FUNDS_SEND = 'Funds transferred to key',
  TRANSFER_TYPE_TRANSFER_FUNDS_DISTRIBUTE = 'Funds received from a transfer',
  TRANSFER_TYPE_CLEAR_ACCOUNT = 'Market-related accounts emptied because market has closed',
  TRANSFER_TYPE_CHECKPOINT_BALANCE_RESTORE = 'Balanced restored after network restart',
}
