...
export const ViewingAsBanner = ({
  ...
  return (
    <div data-testid='view-banner' className="w-full p-2 bg-neutral-800 flex justify-between text-neutral-400">
      <div className="text-base flex items-center justify-center">
        {t('Viewing as Vega user:')} {pubKey && truncateMiddle(pubKey)}
      </div>
      <Button data-testid='exit-view' onClick={disconnect}>{t('Exit view as')}</Button>
    </div>
  );
};
