...
import type NodeRPC from './node-rpc';
import type { Transaction as TxType } from './utils';

export async function getChainId({ rpc }: { rpc: NodeRPC }) {
...
export function getTransactionType(tx: TxType) {
