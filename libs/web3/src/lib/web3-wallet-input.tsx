...
type Web3WalletInputProps = {
  inputProps: Partial<Omit<ComponentProps<typeof Input>, 'appendIconName' | 'prependIconName' | 'appendElement' | 'prependElement'>>;
};
    ...
    return (
      <>
        ...
        <Dialog open={isDialogOpen} onChange={setDialogOpen}>
          <p className="mb-16">{t('Connected with ')}<span className="font-mono">{account}</span></p>
